...
This is the absolute architectural blueprint of the **Automated Infrastructure Provisioning (Systems Administrator)**.

An infrastructure-as-code (IaC) pipeline using Terraform and Ansible. It automatically provisions, configures, and monitors a multi-region cloud deployment with self-healing capabilities.
...
```bash
cd projects/systems-administrator/src
npm install
npm start
```
